...
<body>
	<form class="form-horizontal" autocomplete="off" action="secondCheck_2"
		method="post">
		...
		<div class="modal-body">
			...
			<div class="form-group">
				...
				<div class="col-sm-6">
					<select id="secondCheckStatus" class="form-control"
						data-validate="required:请选择身份信息" name="secondCheckStatus">
