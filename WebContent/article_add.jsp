...
<body >
	...
	<form class="form-horizontal" id="articleAddForm" name="articleAddForm"
		autocomplete="off" action="insertArticle" method="post">
		...
		<div class="modal-body">
			<div class="form-group">
				...
				<div class="col-sm-6">
					<input type="text" class="form-control" name="articleId"
						...
						placeholder="以a字符开头+三位数字编号，如a001" required>
				</div>
				<div class="col-sm-4 tips" id="checkArticleId">
					<span>* </span>必填
				</div>
			</div>
			...
			<div class="form-group">
				<label for="name" class="col-sm-2 control-label">稿件类型</label> <select
					id="ArticleType" name="articleType" id="articleType"
					value="${article.articleType }" required>
			...
			<%
				...
				request.setAttribute("articleWriterId",articleWriterId);
			%>
			<input type="hidden" class="form-control" id="articleWriterId"
				name="articleWriterId" value='${requestScope.articleWriterId}'>
			<div class="form-group">
				...
				<div class="col-sm-6">
					...
					<textarea rows="50%" cols="30%" class="form-control"
						...
						value="${article.articleText}" required></textarea>
				</div>
				<div class="col-sm-4 tips" id="checkArticleText">
					<span>* </span>必填
				</div>
			</div>
