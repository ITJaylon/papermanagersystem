...
<div class="leftnav">
  ...
  <h2><span class="icon-user"></span>初审管理</h2>
  <ul style="display:block">
    <li><a href="getFirstCheckInfo?reviewerId=${reviewer.reviewerId}" target="right"><span class="icon-caret-right"></span>我的初审记录</a></li>
  </ul> 
...
<ul class="bread">
  ...
  <li><b>当前用户：</b><span style="color:red;">${reviewer.getReviewerName()}</php></span>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</li>
</ul>
<div class="admin">
