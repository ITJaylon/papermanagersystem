				...
				<div class="modal-dialog">
					<div class="modal-content">
						<form class="form-horizontal" id="register_form"
							autocomplete="off" action="insertWriter">
							...
							<div class="modal-body">
								<div class="form-group">
									...
									<div class="col-sm-6">
										<input type="text" class="form-control" id="writerId" value=""
											placeholder="以w字符开头+三位数字编号，如w001"  required> <label></label>
									</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-6">
										<input type="password" class="form-control" id="writerPasswd"
											value="" placeholder="6-18位，至少包含1个大写字母，1个小写字母，1个数字" required>
									</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-6">
										<input type="text" class="form-control" id="writerPhone"
											value="" placeholder="输入11位手机号码" required
											>
									</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-6">
										<input type="text" class="form-control" id="writerEmail"
